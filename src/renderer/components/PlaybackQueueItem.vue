...
<template>
    <div class="playback-queue-item" :class="{ 'playback-queue-item-active': active }">
        <div class="item-wrap">
            <div class="left">
            ...
            <div class="right">
                <div class="data">
                    ...
                    <div class="bottom">
                        <div class="artist">
                            <ArtistControl :visitable="true" :platform="data.platform"
                                :data="data.artist" :trackId="data.id"></ArtistControl>
                        </div>
                        <span class="duration" :class="{ 'content-text-highlight': active }">
                            {{ Track.mmssDuration(data) }}
                        </span>
                    </div>
                </div>
                <div class="action">
                    <svg @click="playItem" width="18" height="18" viewBox="0 0 139 139" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
