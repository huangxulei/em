...
const { currentPlatformCategories, updateCurrentCategoryItem } = usePlaylistSquareStore()
    ...
    <div class="playlist-category-view" @click.stop="">
        <div class="container">
            <div class="header">
                ...
                <div class="fl-item content-text-highlight"
                    v-html="currentCategoryItem.data.key"></div>
            </div>
            <div class="center">
