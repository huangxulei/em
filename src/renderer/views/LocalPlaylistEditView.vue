...
<script setup>
import { onMounted, onActivated, ref, reactive, inject } from 'vue';
        ...
        <div class="center">
            ...
            <div class="right">
                <div class="form-row">
                    ...
                    <div @keydown.stop="">
                        <input type="text" :value="detail.title" ref="titleRef" :class="{ invalid }" maxlength="99" placeholder="歌单名称，最多允许输入99个字符" />
                    </div>
                </div>
                <div class="form-row">
                    <div>
                    ...
                    <div @keydown.stop="">
                        <input type="text" :value="detail.tags" ref="tagsRef"
                            :class="{ invalid }" maxlength="128"
