...
const { isRadioModeShortcutEnable, isModulesSettingShortcutEnable, isThemesShortcutEnable,
    isUserHomeShortcutEnable, isSimpleLayoutShortcutEnable } = storeToRefs(useSettingStore())
